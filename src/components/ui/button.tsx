...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-br from-vault-gold to-vault-gold-dark text-vault-green-darker shadow-lg shadow-vault-gold/20 hover:shadow-xl hover:shadow-vault-gold/30 hover:from-vault-gold-light hover:to-vault-gold hover:-translate-y-0.5",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-border bg-transparent hover:bg-muted hover:border-vault-gold/30",
        secondary:
